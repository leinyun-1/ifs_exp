...
if __name__ == '__main__':
    ...
    parser.add_argument("--data_root", type=str, default="g:/winshare_1/dataset/Thuman2.1_norm")  # mesh数据集位置
    parser.add_argument("--save_path", type=str, default='../data')  # 渲染结果数据集位置
